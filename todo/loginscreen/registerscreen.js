...
const RegisterScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.heading, styles.loginHeading]}>Register</Text>
      ...
      <TextInput
        ...
        value={password}
      />
        <Text style={[styles.subHeading,{color:'#979797'}]}>Confirm Password</Text>
      <TextInput
        style={styles.input}
      ...
      <TouchableOpacity style={styles.loginButton} onPress={handleLogin}>
        <Text style={[styles.buttonText, { textAlign: 'center' }]}>Register</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  container: {
    ...
    paddingTop: 240, // Adjust the paddingTop as needed
